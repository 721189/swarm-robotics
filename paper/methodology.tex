...
We optionally extend the scheduler with demand-driven slot doubling when an agent is near a threat or objective; grants are non-preemptive and preserve round-robin order.
D-TDMA is implemented in the released codebase but excluded from the theoretical claims and benchmark matrix of this paper (Sec.~\ref{sec:discussion}).
