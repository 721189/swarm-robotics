...
Because this couples two distinct mechanisms (auction communication and motion-state estimation), we additionally run the allocation-only ablation of Sec.~\ref{sec:setup-ablation}, in which motion is disabled for all baselines, to isolate the contribution of the communication layer to the measured MTC differences.
