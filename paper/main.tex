...
Code, data, and analysis scripts will be released upon acceptance.
\end{abstract}
...
The authors acknowledge the use of AI-assisted tooling during code development and manuscript preparation. All scientific claims, proofs, and experimental results were verified by the authors.
